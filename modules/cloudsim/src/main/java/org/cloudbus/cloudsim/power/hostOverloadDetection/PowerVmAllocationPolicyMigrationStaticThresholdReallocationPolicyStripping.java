 ...
 */
public class PowerVmAllocationPolicyMigrationStaticThresholdReallocationPolicyStripping extends PowerVmAllocationPolicyMigrationStaticThreshold {
			...
			if(host.isSuitableForVm(vm)){
				...
				try {
					...
					if (numberOfVmsInCurrentHost >= -1) {
						if(numberOfVmsInCurrentHost < minimalVmPerHost){
							minimalVmPerHost = numberOfVmsInCurrentHost;
							allocatedHost = host;
						}
					}
				} catch (Exception e) {
