...
////		setSafetyParameter(safetyParameter);
////		setFallbackVmAllocationPolicy(fallbackVmAllocationPolicy);
//		setHostOverUtilisationProcessor(new HostOverUtilisationProcessorMedianAbsoluteDeviation(safetyParameter, new HostOverUtilisationProcessorStaticThreshold(utilizationThreshold, null)));
//
//	}
